...
from pipeline.pipeline_controlnext_base_v3 import StableDiffusionXLControlNeXtPipeline
...
def log_validation(diffmodel, noise_scheduler,vae, unet, controlnet, args, accelerator, weight_dtype, step,
