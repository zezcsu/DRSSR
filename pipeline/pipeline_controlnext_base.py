...
class StableDiffusionXLControlNeXtPipeline(
    ...
    def __init__(
        ...
        self.image_processor = VaeImageProcessor(vae_scale_factor=self.vae_scale_factor,do_resize=True)
    ...
    # def prepare_latents(
    #     self, latent,image, timestep, batch_size, num_images_per_prompt, dtype, device, generator=None, add_noise=True
    # ):
    #
    ...
    def prepare_mask(
        self, mask, batch_size, dtype, device, do_classifier_free_guidance
    ):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if mask_image is not None:
            ...
            mask_binary = self.mask_processor.preprocess(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if  i <  self._num_timesteps//2 and False:
                    print(i)
