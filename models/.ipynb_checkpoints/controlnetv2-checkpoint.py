...
#controlnetv2 : input condition image, mask
...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        #TODO 固定为256应该就可以，参照SDXL addition
        ...
        self.A_res = nn.ModuleList()
        self.B_res = nn.ModuleList()
    ...
    def forward(
        ...
        for a_res ,b_res, attn in zip(self.A_res,  self.B_res, self.attn):
